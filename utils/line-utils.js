...
exports.getUserProfile = async (userId) => {
  return await axios.get(`https://api.line.me/v2/bot/profile/${userId}`, { headers})
    .then((res) => {
      return res.data
    })
...
exports.rawReply = async (messages) => {
  ...
  await axios.post("https://api.line.me/v2/bot/message/reply", body, { headers }).catch(err => { console.log(err.response.data) })
}
